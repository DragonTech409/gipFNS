<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultEnglish.aspx.cs" Inherits="GIP_WebApp.DefaultEnglish" %>
...
<head runat="server">
    ...
    <meta content="GIP - Florim & Nathan & Siebe" name="author"/>
            ...
            <div class="container d-flex align-items-center">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a href="#services">Workplace</a></li>
                        <li><a href="#team">Team</a></li>
                        <li><a href="#contact">Contact</a></li>
                        <li class="drop-down"><a href="#">Language</a>
                            <ul>
                                <li><a href="Default.aspx">Dutch</a></li>
                                <li><a href="DefaultEnglish.aspx">English</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                            <div class="php-email-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TextBoxMessage" runat="server" CssClass="form-control" TextMode="Multiline" Rows="10"></asp:TextBox>
                                    <div class="validate"></div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="text-center">
                                    <asp:Button ID="ButtonSendMessage" runat="server" Text="Send message" CssClass="buttonStyling" OnClick="ButtonSendMessage_Click"/>
                                </div>
                            </div>
                        </div>
